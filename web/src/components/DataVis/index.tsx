...
export default function DataVis(props: any) {
    ...
    const handleDataModeSelect = (event: React.ChangeEvent<{ name?: string; value: unknown }>) => {
    ...
    return (<>
        <div className={classes.header}>
            <FormControl className={classes.formControl}>
                ...
                <FormHelperText>Chose how your data should be displayed</FormHelperText>
            </FormControl>
            <Button variant='contained' color='primary'>Add Datapoint</Button>
        </div>
